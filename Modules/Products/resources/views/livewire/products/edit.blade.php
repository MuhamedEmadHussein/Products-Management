            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <nav class="text-sm text-gray-600">
                        <a href="{{ route('dashboard') }}" class="hover:text-blue-600">{{ __('Home') }}</a> / <a href="{{ route('products.index') }}" class="hover:text-blue-600">{{ __('Products') }}</a> / {{ __('Edit') }}
                    </nav>
                </div>
            </div>
                                ...
                                <div class="flex space-x-2">
                                    @foreach($availableLocales as $loc)
                                        <button type="button" 
                                            ...
                                            class="px-3 py-1 rounded {{ $locale == $loc ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700' }}">
                                            {{ strtoupper($loc) }}
                                        </button>
                                    @endforeach
                                </div>
