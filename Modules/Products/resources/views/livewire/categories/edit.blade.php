    ...
    <main class="nxl-container p-6">
        <div class="nxl-content">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">{{ __('Edit Category') }}</h1>
                    <nav class="text-sm text-gray-600">
                        <a href="{{ route('dashboard') }}" class="hover:text-blue-600">{{ __('Home') }}</a> / <a href="{{ route('categories.index') }}" class="hover:text-blue-600">{{ __('Categories') }}</a> / {{ __('Edit') }}
                    </nav>
                </div>
