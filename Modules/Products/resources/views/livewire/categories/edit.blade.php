    ...
    <main class="nxl-container p-6">
        <div class="nxl-content">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <nav class="text-sm text-gray-600">
                        <a href="{{ route('dashboard') }}" class="hover:text-blue-600">Home</a> / <a href="{{ route('categories.index') }}" class="hover:text-blue-600">Categories</a> / Edit
                    </nav>
                </div>
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <form id="category-form" wire:submit.prevent="updateCategory">
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Category Name</label>
                            <input type="text" class="form-control w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" id="name" wire:model="name" placeholder="Enter category name">
                            @error('name')
